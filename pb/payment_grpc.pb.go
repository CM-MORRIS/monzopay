...
const (
	PaymentService_Healthz_FullMethodName        = "/proto.PaymentService/Healthz"
...
func (c *paymentServiceClient) Healthz(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
...
func (UnimplementedPaymentServiceServer) Healthz(context.Context, *emptypb.Empty) (*HealthResponse, error) {
...
func _PaymentService_Healthz_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).Healthz(ctx, req.(*emptypb.Empty))
	}
